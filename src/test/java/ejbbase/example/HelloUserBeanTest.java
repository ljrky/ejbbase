...
import ejbbase.example.HelloUser;
import ejbbase.example.HelloUserBean;
...
public class HelloUserBeanTest {
    ...
    public void testSayHello() {
        ...
        Assert.assertEquals("Message did not match.","Hello Curious George welcome to EJB!",helloMessage);
    }
}
